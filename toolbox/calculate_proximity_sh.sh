...
nodes_from_prefix="/home/wch23/Project/LifeArc/General/data/Drug/DTScratch2/stitch_drugbank_target_intarctions"
...
for i in {1..25}
do
    python p01_calculate_proximity_from_nature.py -e ${network_file} -s ${nodes_from_prefix}_$i.tsv -t $nodes_to -d $disease_name -o ${output_prefix}_$i.txt &
done
